...
Pong = {
  ...
  Images: [
    "/games/pong/js/images/press1.png",
    "/games/pong/js/images/press2.png",
    "/games/pong/js/images/winner.png"
  ],
  ...
  Menu: {
    ...
    initialize: function(pong) {
      var press1 = pong.images["/games/pong/js/images/press1.png"];
      var press2 = pong.images["/games/pong/js/images/press2.png"];
      var winner = pong.images["/games/pong/js/images/winner.png"];
